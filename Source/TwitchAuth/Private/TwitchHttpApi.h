 ...
 *          D:\Projects\fivefingergames\FFGPlugins\Plugins\TwitchAuth\Source\TwitchAuth\Private\TwitchHttpApi.h
 *
 * @brief   A static class to capsule the Twitch HTTP API.
 */
UCLASS()
class UTwitchHttpApi : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
